...
![DIFIX3D]({{ site.baseurl }}/assets/DIFIX3D/difix3d_thumb.png)
...
[**NeRF**](https://jiwonhaha.github.io/jtech-blog/paper%20review/NeRF/) volume rendering for a ray $$r(t)=\mathbf{o}+t\mathbf{d}$$:  
$$
C = \sum_{i=1}^{N} \alpha_i\, \mathbf{c}_i \prod_{j<i}(1-\alpha_j),
\quad \alpha_i = 1 - \exp(-\sigma_i \,\delta_i).
$$

[**3DGS**](https://jiwonhaha.github.io/jtech-blog/paper%20review/3DGS/) replaces sampled points with Gaussians (mean $$\boldsymbol\mu_i$$, covariance $$\boldsymbol\Sigma_i$$, opacity $$\eta_i$$):  
$$
...
![DIFIX3D]({{ site.baseurl }}/assets/DIFIX3D/difix3d_main.png)
...
$$L = \underbrace{\| \hat{I}-I \|_2^2}_{L_{\text{Recon}}} + \underbrace{\text{LPIPS}(\hat{I}, I)}_{L_{\text{Percep}}} + \underbrace{0.5\,\sum_{\ell}\|\mathbf{G}_\ell(\hat{I})-\mathbf{G}_\ell(I)\|_2^2}_{L_{\text{Gram}}}$$,
...
![DIFIX3D]({{ site.baseurl }}/assets/DIFIX3D/difix3d_eval.png)
