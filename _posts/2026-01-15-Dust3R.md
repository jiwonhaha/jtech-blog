...
This is the "magic trick." By forcing the network to predict View 2's geometry in View 1's frame, the network **implicitly solves the relative pose** $$[R \mid t]$$ between the cameras and applies it to the geometry. You don't need to mathematically enforce epipolar constraints; the network learns them as a data-driven prior.
